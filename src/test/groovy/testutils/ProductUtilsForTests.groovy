...
class ProductUtilsForTests extends Specification {
    ...
    private static List<List<Product>> getPreparedListOfProductLists() {
        ...
        listOfProductLists.add(createProducts(FLOWER, MIRROR, KNIFE, CHOCOLATE, KNIFE, COMPUTER, BIKE, BOOK, JUICE, BIKE, COMPUTER, MIRROR, BIKE, CAR, COMPUTER, BIKE, CHOCOLATE))
        ...
        listOfProductLists.add(createProducts(KNIFE, FLOWER, KNIFE, CAR, COMPUTER, KNIFE, MIRROR, CHOCOLATE, BIKE, CAR, MIRROR, BOOK, MIRROR, COMPUTER, CAR, KNIFE, VIDEO_GAME, JUICE, CHOCOLATE, BIKE))
        listOfProductLists.add(createProducts(FLOWER, FLOWER, MIRROR, MIRROR, BIKE, CAR, COMPUTER, MIRROR, BOOK, KNIFE, CAR, COMPUTER, MIRROR))
        ...
        listOfProductLists.add(createProducts(CHOCOLATE, FLOWER, COMPUTER, BIKE, CHOCOLATE, MIRROR, CAR, MIRROR, BOOK, FLOWER, FLOWER, MIRROR, FLOWER))
